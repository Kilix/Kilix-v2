...
var Kilix={currentScroll:null,currentPos:null,animSvg:!$("html").hasClass("no-anim-svg"),colors:{col1:"#61AFF0",col2:"#ff4a46",col3:"#009884",col4:"#e79027",col5:"#087ec2"},init:function(){Kilix.resize(),Kilix.pushState(),Kilix.switchSVG(),Kilix.nav(),setTimeout(function(){Kilix[$(".container").data("page")].init()},300)},resize:function(){Kilix.resizeLanding(),$(window).resize(function(){Kilix.resizeLanding()})},resizeLanding:function(){var i=$(window).height();matchMedia("(min-width: 40em)").matches?($(".landing-home").css("height",i),$(".home .intro.desktop").css("margin-top",i)):($(".landing-home").attr("style",""),$(".home .intro.desktop").attr("style",""))},pushState:function(){function i(i){var t=i.url,a=$(".container").data("page");$("title").html(l[i.title.toLowerCase()]),n=e[i.title.toLowerCase()],$(".nav-link.current").removeClass("current"),$('.nav-link[data-pos="'+n+'"]').addClass("current"),o=n>Kilix.currentPos?!0:!1,$(".main-wrapper").append("<div class='wrapper wrapper-new'></div>"),o||$(".wrapper-new").addClass("wrapper-prev"),$(".wrapper-new").load(t+" .container",function(){Kilix[a].destroy(),Kilix.resizeLanding(),Kilix.switchSVG();var t=$(".wrapper:first-child"),n=$(".wrapper-new"),e=$(".main-wrapper");$("html, body").scrollTop(0);var l=o?"page-moveToLeftEasing":"page-moveToRightEasing",s=o?"page-moveFromRight":"page-moveFromLeft";t.addClass(l).addClass("page-ontop"),n.addClass(s).on(r,function(){n.off(r),e.removeClass("page-perspective"),$(".wrapper:first-child").remove(),$(".wrapper").removeClass(s),$(".wrapper-new").removeClass("wrapper-new"),$(".wrapper-prev").removeClass("wrapper-prev"),$(".nav-links-wrapper a, .footer-links a").addClass("enabled"),Pos=$(".container").data("pos"),Kilix[i.title.toLowerCase()].init()})})}function t(t){i(t)}"file:"===document.location.protocol&&alert("The HTML5 History API (and thus History.js) do not work on files, please upload it to a server.");// Establish Variable!
{var n,a=window.History,o=(a.getState(),!0),e={home:1,team:2,agilite:3,contact:4},l={home:$("#link-home").attr("title"),team:$("#link-team").attr("title"),agilite:$("#link-agilite").attr("title"),contact:$("#link-contact").attr("title")},s={WebkitAnimation:"webkitAnimationEnd",OAnimation:"oAnimationEnd",msAnimation:"MSAnimationEnd",animation:"animationend"},r=s[Modernizr.prefixed("animation")];Modernizr.cssanimations}a.Adapter.bind(window,"statechange",function(){var i=a.getState();if(""==i.title){url=i.url;var n=/^https?:\/\/[a-z\:0-9.\-\_]+/,o="",e=n.exec(url);null!=e&&(o=e[0]),o.length>0&&(url=url.replace(o,""),url=url.replace("/",""),""==url&&(url="home")),i.title=url.toLowerCase()}t(i)}),history.pushState&&$(".nav-links-wrapper a.enabled, .footer-links a.enabled").on("click",Kilix.bindPushState)},bindPushState:function(i){if(i.preventDefault(),$(this).hasClass("enabled")&&!$(this).hasClass("current")){$(".nav-links-wrapper a, .footer-links a").removeClass("enabled"),$("body").removeClass("unfolded"),Kilix.currentPos=$(".nav-link.current").data("pos"),Kilix.currentScroll=void 0!=$(this).data("scroll")?$(this).data("scroll"):null;var t=$(this).attr("data-scroll")?$(this).data("page-title"):this.textContent;History.pushState(null,t,this.href),i.preventDefault()}},switchSVG:function(){Modernizr.svg?$("img.svg").each(function(){var i=$(this),t=i.attr("id"),n=i.attr("class"),a=i.attr("src");$.get(a,function(a){var o=$(a).find("svg");"undefined"!=typeof t&&(o=o.attr("id",t)),"undefined"!=typeof n&&(o=o.attr("class",n+" replaced-svg")),o=o.removeAttr("xmlns:a"),i.replaceWith(o)})}):$('img.svg[src*="svg"]').attr("src",function(){return $(this).attr("src").replace(".svg",".png")})},nav:function(){$(".toggle-menu").on("click",function(){$(".nav-links-wrapper").removeClass("nav-links-hidden"),$("body").toggleClass("unfolded"),window.setTimeout(function(){$("body").hasClass("unfolded")||$(".nav-links-wrapper").addClass("nav-links-hidden")},605)}),$(".back-to-top").on("click",function(){$("html, body").animate({scrollTop:0},"slow")}),$(".nav-link-contact").on("click",function(){$("html, body").animate({scrollTop:$("body").height()},"slow")})},wayPoints:function(){$("footer").waypoint({handler:function(i){"down"==i?$(".back-to-top").addClass("force-opacity"):$(".back-to-top").removeClass("force-opacity")},offset:"bottom-in-view"}),$(".intro").waypoint(function(){$(".navbar").toggleClass("navbar-top")},{offset:"100px"}),$(".landing h1, .landing-main-text, #KILIX-logo").on("click",function(){$("html, body").animate({scrollTop:$(".intro").offset().top-80},"slow")})},changeXColor:function(i,t){"none"!=t?($(".logo").addClass("animated"),setTimeout(function(){$(".logo").removeClass("animated")},2e3),i.each(function(i){var n=$(this);setTimeout(function(){n.css("fill",t)},100*(i+1))})):($(".logo").addClass("animated"),setTimeout(function(){$(".logo").removeClass("animated")},2e3),i.each(function(i){var t=$(this);setTimeout(function(){t.attr("style","")},100*(i+1))}))},animations:{},home:{init:function(){Kilix.wayPoints(),Kilix.resize(),$(".landing-home").addClass("play"),setTimeout(function(){$(".landing-home").removeClass("play")},1e3);var i="50%";history.pushState&&$(".svg-anim a.button.enabled").on("click",Kilix.bindPushState),$(".next-section").on("click",function(){$("html, body").animate({scrollTop:$(this).closest(".❤").next().offset().top-90},"slow")}),$(".losange").on("click",function(){$("html, body").animate({scrollTop:$(".svg-valeur").offset().top-90},"slow")});var t=$(".❤");if(t.waypoint({handler:function(){var i=Kilix.colors[$(this).data("color")];Kilix.changeXColor($(".logo svg polygon"),i)},offset:"25%"}),Kilix.animSvg){var n=!1;Kilix.animations.risques.setAnimStatus(!1),$(".svg-risque").waypoint(function(){0==n&&Kilix.animations.risques.start(),n=!0},{offset:i});var a=!1;Kilix.animations.valeur.setValueAnimStatus(!0),Kilix.animations.valeur.setValueLoadingStatus(!1),$(".svg-valeur").waypoint(function(){0==a&&Kilix.animations.valeur.start(),a=!0},{offset:i});var o=!1;Kilix.animations.amelioration.setAnimStatus(!1),$(".svg-amelio").waypoint(function(){0==o&&Kilix.animations.amelioration.start(),o=!0},{offset:i});var e=!1;Kilix.animations.extia.setAnimStatus(!1),$(".svg-extia").waypoint(function(){0==e&&Kilix.animations.extia.start(),e=!0},{offset:i}),null!=Kilix.currentScroll&&$("html, body").animate({scrollTop:$(".scroll-item").eq(Kilix.currentScroll).offset().top-200},"slow")}$(".png-anim").on("click",function(){var i=new Image;i.style.height=$(this).height()+"px",i.style.marginLeft="auto",i.style.marginRight="auto",i.style.marginTop="-"+$(this).height()+"px",i.style.display="none",$(this).off(),$(this).after(i),i.onload=function(i,t){i.style.display="block",t.css("opacity",0)}(i,$(this)),i.src=$(this).attr("data-gif")})},destroy:function(){Kilix.animations.extia.freeIntervals(),Kilix.animations.valeur.freeIntervals(),Kilix.animations.risques.freeIntervals(),$.waypoints("destroy"),$(".svg-anim a.button.enabled").off(),$(".next-section").off(),$(".navbar").addClass("navbar-top"),Kilix.changeXColor($(".logo svg polygon"),"none"),$(".landing h1, .landing-main-text, #KILIX-logo").off()}},agilite:{init:function(){Kilix.wayPoints(),Kilix.switchSVG(),$(".button-back").on("click",Kilix.bindPushState),$(".losange").on("click",function(){$("html, body").animate({scrollTop:$(".content.desktop").offset().top-90},"slow")}),setTimeout(function(){Kilix.changeXColor($(".logo svg polygon"),"none")},300);var i=!1;$(".svg-agilite").eq("0").waypoint(function(){0==i&&(setTimeout(function(){Kilix.animations.agilite.startValueAnimation()},500),i=!0)},{offset:"70%"});var t=!1;$(".svg-agilite").eq("1").waypoint(function(){0==t&&(Kilix.animations.agilite.startRiskAnimation(),t=!0)},{offset:"70%"});var n=!1;$(".svg-agilite").eq("2").waypoint(function(){0==n&&(Kilix.animations.agilite.startAdaptAnimation(),n=!0)},{offset:"70%"});var a=!1;$(".svg-agilite").eq("3").waypoint(function(){0==a&&(Kilix.animations.agilite.startVisAnimation(),a=!0)},{offset:"70%"}),null!=Kilix.currentScroll&&$("html, body").animate({scrollTop:$(".scroll-item").eq(Kilix.currentScroll).offset().top-150},"slow")},destroy:function(){$(".navbar").addClass("navbar-top"),$.waypoints("destroy"),Kilix.changeXColor($(".logo svg polygon"),"none"),$(".landing h1, .landing-main-text, #KILIX-logo").off(),$(".button-back").off()}},team:{init:function(){Kilix.wayPoints();var i="70%";if($(".losange").on("click",function(){$("html, body").animate({scrollTop:$(".svg-anim").offset().top-90},"slow")}),Kilix.animSvg){var t=!1;Kilix.animations.team.setAnimStatus(!1),$(".svg-anim").waypoint(function(){0==t&&Kilix.animations.team.start(),t=!0},{offset:i})}setTimeout(function(){Kilix.changeXColor($(".logo svg polygon"),Kilix.colors.col3)},300),$(".raptor").on("click",function(){$("body").raptorize()})},destroy:function(){$.waypoints("destroy"),$(".navbar").addClass("navbar-top"),$(".landing h1, .landing-main-text, #KILIX-logo").off(),Kilix.changeXColor($(".logo svg polygon"),"none")}}};$(function(){Kilix.init()});
